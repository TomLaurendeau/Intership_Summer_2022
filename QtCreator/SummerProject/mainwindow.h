...
private slots:
    ...
    static void plot_txt(task_characteristic *output, char *counter, int number, char *app, char* date_str);
    ...
    void on_comboBox_timeMax_currentIndexChanged(const QString &arg1);

    void on_pushButton_Plot_Analysis_clicked();

    void on_actionSave_Argument_triggered();

    void on_actionDelete_Argument_triggered();

    void on_actionOpen_Argument_triggered();

public slots:
    int runThread(std::vector<double> instr_ret,
    ...
    void startPlotThread(std::vector<double> instr_ret,
                         std::vector<double> counter_1,
                         std::vector<double> counter_2,
                         std::vector<double> counter_3,
                         std::vector<double> counter_4,
    ...
    void ThreadToPlot(std::vector<double> instr_ret_threadPlot,
