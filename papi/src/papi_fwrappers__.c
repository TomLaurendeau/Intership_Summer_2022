...
void papif_flips_rate__ ( int event, float *real_time, float *proc_time, long long *flpins, float *mflips, int *check )
...
void papif_flops_rate__ ( int event, float *real_time, float *proc_time, long long *flpops, float *mflops, int *check )
